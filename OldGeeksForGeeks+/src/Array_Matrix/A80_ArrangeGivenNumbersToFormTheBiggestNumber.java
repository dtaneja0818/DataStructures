...
public class A80_ArrangeGivenNumbersToFormTheBiggestNumber {
	...
	public static void main(String[] args) {
		A80_ArrangeGivenNumbersToFormTheBiggestNumber obj = new A80_ArrangeGivenNumbersToFormTheBiggestNumber();
