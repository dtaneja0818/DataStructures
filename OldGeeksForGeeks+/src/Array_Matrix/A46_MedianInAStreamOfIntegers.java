...
public class A46_MedianInAStreamOfIntegers {
	public Queue<Integer> minHeap;
	public Queue<Integer> maxHeap;
	public int numOfElements;

	public A46_MedianInAStreamOfIntegers() {
	...
	public static void main(String[] args) {
		A46_MedianInAStreamOfIntegers streamMedian = new A46_MedianInAStreamOfIntegers();
