 ...
 */
public class A96_FindMinimumElementInSortedAndRotatedArray {
	...
	public static void main(String[] args) {
		A96_FindMinimumElementInSortedAndRotatedArray obj = new A96_FindMinimumElementInSortedAndRotatedArray();
