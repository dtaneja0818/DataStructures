...
public class S28_FindFirstNonRepeatingCharacterFromStreamOfCharacters {
	...
	public static void main(String[] args) {
		S28_FindFirstNonRepeatingCharacterFromStreamOfCharacters obj = new S28_FindFirstNonRepeatingCharacterFromStreamOfCharacters();
