 ...
 */
public class S70_RearrangeStringSoThatAllSameCharBecomeAtleastdDistanceAway {
	...
	public static void main(String[] args) {
		S70_RearrangeStringSoThatAllSameCharBecomeAtleastdDistanceAway obj = new S70_RearrangeStringSoThatAllSameCharBecomeAtleastdDistanceAway();
