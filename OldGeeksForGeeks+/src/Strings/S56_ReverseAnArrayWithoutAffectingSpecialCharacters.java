 ...
 */
public class S56_ReverseAnArrayWithoutAffectingSpecialCharacters {
	...
	public static void main(String[] args) {
		S56_ReverseAnArrayWithoutAffectingSpecialCharacters obj = new S56_ReverseAnArrayWithoutAffectingSpecialCharacters();
