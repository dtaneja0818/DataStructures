 ...
 */
public class S16_CheckWhetheraStringIsAnInterleavingOfTwoOtherStrings {
	...
	public static void main(String[] args) {
		S16_CheckWhetheraStringIsAnInterleavingOfTwoOtherStrings obj = new S16_CheckWhetheraStringIsAnInterleavingOfTwoOtherStrings();
		String s1 = "XXY";
		String s2 = "XXZ";
		String s3 = "XXZXXXY";
