 ...
 */
public class S84_CountNumberOfSubstringsWithExactlykDistinctCharacters {
	...
	public static void main(String[] args) {
		S84_CountNumberOfSubstringsWithExactlykDistinctCharacters ob = new S84_CountNumberOfSubstringsWithExactlykDistinctCharacters();
		String ch = "abcbaa";
		int k = 3;
