 ...
 */
public class S45_FindLongestSubstringWithkUniqueCharactersInaGivenString {
	...
	public static void main(String[] args) {
		S45_FindLongestSubstringWithkUniqueCharactersInaGivenString obj = new S45_FindLongestSubstringWithkUniqueCharactersInaGivenString();
		String s = "aaabbb";
	    int k = 3;
	    obj.kUniques(s, k);
	}
