 ...
 * 
 */
public class S43_FindMaximumDepthOfNestedParenthesisInaString {
	...
	public static void main(String[] args) {
		S43_FindMaximumDepthOfNestedParenthesisInaString obj = new S43_FindMaximumDepthOfNestedParenthesisInaString();
		String s = "( ((X)) (((Y))) )";
