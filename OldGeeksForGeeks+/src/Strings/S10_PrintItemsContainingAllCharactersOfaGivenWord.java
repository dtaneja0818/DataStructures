 ...
 */
public class S10_PrintItemsContainingAllCharactersOfaGivenWord {
	...
	public static void main(String[] args) {
		S10_PrintItemsContainingAllCharactersOfaGivenWord obj = new S10_PrintItemsContainingAllCharactersOfaGivenWord();
