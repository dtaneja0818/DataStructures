 ...
 */
public class S37_GivenTwoStringsFindIfFirstStringIsaSubsequenceOfSecond {
	...
	public static void main(String[] args) {
		S37_GivenTwoStringsFindIfFirstStringIsaSubsequenceOfSecond obj = new S37_GivenTwoStringsFindIfFirstStringIsaSubsequenceOfSecond();
