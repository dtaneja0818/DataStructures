 ...
 * Time Complexity: O(n) 
 */
public class S46_CheckIfaGivenSequenceOfMovesForRobotIsCircular {
	...
	public static void main(String[] args) {
		S46_CheckIfaGivenSequenceOfMovesForRobotIsCircular obj = new S46_CheckIfaGivenSequenceOfMovesForRobotIsCircular();
		String str = "GLGLGLG";
