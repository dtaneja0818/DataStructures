 ...
 * TODO: NOT WORKING
 */
public class S67_GenerateAllBinaryStringsFromGivenPattern {
	...
	public static void main(String[] args) {
		S67_GenerateAllBinaryStringsFromGivenPattern obj = new S67_GenerateAllBinaryStringsFromGivenPattern();
		String str = "1??0?101"; 
	    obj.approach1(str, 0);
	}
}
