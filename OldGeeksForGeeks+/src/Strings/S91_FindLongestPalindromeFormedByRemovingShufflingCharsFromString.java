 ...
 */
public class S91_FindLongestPalindromeFormedByRemovingShufflingCharsFromString {
	...
	public static void main(String[] args) {
		S91_FindLongestPalindromeFormedByRemovingShufflingCharsFromString obj = new S91_FindLongestPalindromeFormedByRemovingShufflingCharsFromString();
		String str = "abbaccd";
