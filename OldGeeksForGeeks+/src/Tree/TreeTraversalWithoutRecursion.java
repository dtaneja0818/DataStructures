...
public class TreeTraversalWithoutRecursion{
	...
	public TreeNode insert(TreeNode root, char input){
		// empty tree
		if(root == null){
	...
	public static void main(String[] args){
		/*Code To Test the logic
         ...
         A  C       I
                  ...
                  H 
		 */
		TreeTraversalWithoutRecursion traverse = new TreeTraversalWithoutRecursion();
		TreeNode root = null;
		root = traverse.insert(root,'F');
		root = traverse.insert(root,'D');
		root = traverse.insert(root,'J');
		root = traverse.insert(root,'B');
		root = traverse.insert(root,'E');
		root = traverse.insert(root,'G');
		root = traverse.insert(root,'K');
		root = traverse.insert(root,'A');
		root = traverse.insert(root,'C');
		root = traverse.insert(root,'I');
		root = traverse.insert(root,'H');
		...
		System.out.println();
		System.out.print("Inorder Traversal without stack is:");
		traverse.inOrderTraversalWithoutStack(root);
		System.out.println();
	}
}
