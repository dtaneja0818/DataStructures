 ...
 */
public class BT25_ConvertBinaryTreeToTreeThatHoldsChildrenSumProperty {
	...
	public static void main(String[] args) {
		BT24_CheckChildrenSumPropertyInBinaryTree obj = new BT24_CheckChildrenSumPropertyInBinaryTree();	
