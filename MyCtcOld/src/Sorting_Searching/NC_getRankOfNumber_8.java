 ...
 * the data structures and algorithms to support these operations. That is, implement the 
 * method track(int x), which is called when each number is generated,and the methodgetRankOfNumber (int x), 
 * which returns the number of values less than or equal to x (not including x itself).
 * 
 * 
 */
public class NC_getRankOfNumber_8 {
