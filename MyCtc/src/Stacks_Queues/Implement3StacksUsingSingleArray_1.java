 ...
 */
public class Implement3StacksUsingSingleArray_1 {
	private int maxSize;
	private int[] top = {-1,-1,-1};
	private int[] arr;;
	
	public Implement3StacksUsingSingleArray_1(int size){
		maxSize = size;
		arr = new int[maxSize];
	}
	...
	public static void main(String[] args) {
		Implement3StacksUsingSingleArray_1 obj = new Implement3StacksUsingSingleArray_1(9);
		try{
			obj.push(0,1);
			obj.push(0,1);
			obj.push(0,1);
