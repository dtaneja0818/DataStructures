...
public class A61_FindSortedSubsequenceOfSize3InLinearTime {
	...
	public static void main(String[] args) {
		A61_FindSortedSubsequenceOfSize3InLinearTime obj = new A61_FindSortedSubsequenceOfSize3InLinearTime();
		int[] arr = {1, 2, 3, 4};
