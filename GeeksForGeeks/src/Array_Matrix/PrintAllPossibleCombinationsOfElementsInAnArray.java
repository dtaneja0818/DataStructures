...
public class PrintAllPossibleCombinationsOfElementsInAnArray {
	...
	public static void main(String[] args) {
		PrintAllPossibleCombinationsOfElementsInAnArray obj = new PrintAllPossibleCombinationsOfElementsInAnArray(); 
		int arr[] = {1, 2, 3, 4, 5};
		int r = 3;
