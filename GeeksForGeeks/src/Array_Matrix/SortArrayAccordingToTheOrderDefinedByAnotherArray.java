 ...
 */
public class SortArrayAccordingToTheOrderDefinedByAnotherArray {
	...
	public static void main(String[] args) {
		SortArrayAccordingToTheOrderDefinedByAnotherArray obj = new SortArrayAccordingToTheOrderDefinedByAnotherArray();
