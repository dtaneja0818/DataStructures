 ...
 */
public class MergeaLinkListIntoAnotherLinkListAtAlternatePositions {
	...
	public static void main(String[] args) {
		MergeaLinkListIntoAnotherLinkListAtAlternatePositions obj = new MergeaLinkListIntoAnotherLinkListAtAlternatePositions();
		ListNode head1 = null;
		ListNode head2 = null;
		ListNode head = null;
