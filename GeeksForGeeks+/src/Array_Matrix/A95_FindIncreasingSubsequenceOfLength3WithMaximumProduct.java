 ...
 * O(nLogn)
 */
public class A95_FindIncreasingSubsequenceOfLength3WithMaximumProduct {
    ...
    public static void main(String[] args) {
    	A95_FindIncreasingSubsequenceOfLength3WithMaximumProduct solution = new A95_FindIncreasingSubsequenceOfLength3WithMaximumProduct(); 
