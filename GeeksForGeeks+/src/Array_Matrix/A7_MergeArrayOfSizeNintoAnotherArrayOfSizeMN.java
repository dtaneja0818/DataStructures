 ...
 */
public class A7_MergeArrayOfSizeNintoAnotherArrayOfSizeMN {
	...
	public static void main(String[] args) {
		A7_MergeArrayOfSizeNintoAnotherArrayOfSizeMN obj = new A7_MergeArrayOfSizeNintoAnotherArrayOfSizeMN();
		int[] a = {1,-1,-1,4,5,6};
		int[] b = {2,3};
