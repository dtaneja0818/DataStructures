...
public class A92_PrintAllPossibleCombinationsOfElementsInAnArray {
...
//	        i++;
	...
	public static void main(String[] args) {
		A92_PrintAllPossibleCombinationsOfElementsInAnArray obj = new A92_PrintAllPossibleCombinationsOfElementsInAnArray(); 
		int arr[] = {1, 2, 1, 3, 1};
		int r = 3;
