...
public class A93_FindAllElementsThatAppearMoreThanNKTimes {
	...
	public static void main(String[] args) {
		A93_FindAllElementsThatAppearMoreThanNKTimes obj = new A93_FindAllElementsThatAppearMoreThanNKTimes();
		int [] A = {4, 5, 6, 7, 8, 4, 4};
