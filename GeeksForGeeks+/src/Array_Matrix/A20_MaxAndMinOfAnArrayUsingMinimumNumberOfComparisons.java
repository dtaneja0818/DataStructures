...
public class A20_MaxAndMinOfAnArrayUsingMinimumNumberOfComparisons {
	...
	public static void main(String[] args) {
		A20_MaxAndMinOfAnArrayUsingMinimumNumberOfComparisons obj = new A20_MaxAndMinOfAnArrayUsingMinimumNumberOfComparisons();
