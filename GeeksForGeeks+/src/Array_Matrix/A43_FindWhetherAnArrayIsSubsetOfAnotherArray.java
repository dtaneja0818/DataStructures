 ...
 */
public class A43_FindWhetherAnArrayIsSubsetOfAnotherArray {
	...
	public static void main(String[] args) {
		A43_FindWhetherAnArrayIsSubsetOfAnotherArray obj = new A43_FindWhetherAnArrayIsSubsetOfAnotherArray();
		int[] a1 = {1,4,2,2};
		int[] a2 = {1,4,2};
