 ...
 * Auxiliary space – O(1)
 */
public class S38_CheckaSentenceForGivenSetOfSimpleGrammerRules {
	...
	public static void main(String[] args) {
		S38_CheckaSentenceForGivenSetOfSimpleGrammerRules obj = new S38_CheckaSentenceForGivenSetOfSimpleGrammerRules();
		String str[] = { 
				"I love cinema.",
				"The vertex is S.",
				"I am single.",
