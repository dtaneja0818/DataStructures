 ...
 */
public class S90_CalculateSumOfAllNumbersPresentInaString {
	...
	public static void main(String[] args) {
		S90_CalculateSumOfAllNumbersPresentInaString obj = new S90_CalculateSumOfAllNumbersPresentInaString();
