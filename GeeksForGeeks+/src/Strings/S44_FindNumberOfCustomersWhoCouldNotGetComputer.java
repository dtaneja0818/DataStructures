 ...
 */
public class S44_FindNumberOfCustomersWhoCouldNotGetComputer {
	...
	public static void main(String[] args) {
		S44_FindNumberOfCustomersWhoCouldNotGetComputer obj = new S44_FindNumberOfCustomersWhoCouldNotGetComputer();
