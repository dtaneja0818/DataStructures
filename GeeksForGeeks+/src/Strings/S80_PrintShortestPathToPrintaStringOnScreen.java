 ...
 */
public class S80_PrintShortestPathToPrintaStringOnScreen {
	...
	public static void main(String[] args) {
		S80_PrintShortestPathToPrintaStringOnScreen obj = new S80_PrintShortestPathToPrintaStringOnScreen();
		String str = "COZY";
