 ...
 */
public class S61_MinNumberOfPalindromicSubsequencesRemovedToEmptyBinaryString {
	...
	public static void main(String[] args) {
		S61_MinNumberOfPalindromicSubsequencesRemovedToEmptyBinaryString obj = new S61_MinNumberOfPalindromicSubsequencesRemovedToEmptyBinaryString();
