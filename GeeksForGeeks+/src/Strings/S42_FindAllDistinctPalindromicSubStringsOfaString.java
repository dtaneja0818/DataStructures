 ...
 */
public class S42_FindAllDistinctPalindromicSubStringsOfaString {
	...
	public static void main(String[] args) {
		S42_FindAllDistinctPalindromicSubStringsOfaString obj = new S42_FindAllDistinctPalindromicSubStringsOfaString();
