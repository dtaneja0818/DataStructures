 ...
 */
public class S102_StringWithAdditiveSequence {
	...
	public boolean isAdditiveNumber(String num) {
	  ...
	  private boolean isValid(String num, int j, int i) {
	    String s1 = num.substring(0,j);
	    String s2 = num.substring(j,i);
	    int sumStart = i;
	    while(sumStart < num.length()) {
	      
	      // if the s1 or s2 have leading 0
	      // they are not valid
	...
	public static void main(String[] args) {
		S102_StringWithAdditiveSequence obj = new S102_StringWithAdditiveSequence();
		String num = "23581320";
