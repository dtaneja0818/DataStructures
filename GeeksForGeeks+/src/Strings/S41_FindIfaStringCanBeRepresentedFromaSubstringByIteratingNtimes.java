 ...
 */
public class S41_FindIfaStringCanBeRepresentedFromaSubstringByIteratingNtimes {
	...
	public static void main(String[] args) {
		S41_FindIfaStringCanBeRepresentedFromaSubstringByIteratingNtimes obj = new S41_FindIfaStringCanBeRepresentedFromaSubstringByIteratingNtimes();
