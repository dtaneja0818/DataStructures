 ...
 */
public class S40_PrintAllPossibleStringsThatCanBeMadeByPlacingSpaces {
	...
	public static void main(String[] args) {
		S40_PrintAllPossibleStringsThatCanBeMadeByPlacingSpaces obj = new S40_PrintAllPossibleStringsThatCanBeMadeByPlacingSpaces();
		String str = "ABCD";
