 ...
 */
public class S47_RecursivelyPrintAllSentencesFormedFromListOfWordLists {
	...
	public static void main(String[] args) {
		S47_RecursivelyPrintAllSentencesFormedFromListOfWordLists obj = new S47_RecursivelyPrintAllSentencesFormedFromListOfWordLists();
