 ...
 */
public class S69_InplaceReplaceMultipleOccurrencesOfaPattern {
	...
	public static void main(String[] args) {
		S69_InplaceReplaceMultipleOccurrencesOfaPattern obj = new S69_InplaceReplaceMultipleOccurrencesOfaPattern();
