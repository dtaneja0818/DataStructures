 ...
 */
public class FindTripletFromThreeLinkListWithSumEqualToaGivenNumber {
	// complexity n3
	...
	public static void main(String[] args) {
		FindTripletFromThreeLinkListWithSumEqualToaGivenNumber obj = new FindTripletFromThreeLinkListWithSumEqualToaGivenNumber();
		ListNode head1 = null;
		ListNode head2 = null;
		ListNode head3 = null;
		ListNode head = null;
